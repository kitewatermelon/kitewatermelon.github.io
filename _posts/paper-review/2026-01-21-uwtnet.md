...
본 논문에서는 위의 문제를 인지하고 [WTconv]({% post_url paper-review/2026-01-19-wtconv %})에 영감을 받아 Image Multi-Frequency Information Extraction(IMFIE) block을 제안한다. 이 블록은 표준 Convolution과 WTconv의 장점을 결합하여 medical image segmentation에서 저주파 정보를 극대화하고 활용할 수 있도록 한다.

## Method
아래 그림은 UWT-Net의 전체 구조이다. encoder에서는 IMFIE 블록이 feature를 뽑으며 해상도의 절반을 줄이는 반면 decoder에서는 해상도를 두배로 올려 복구한다. 

<center>
<img src="{{ '/assets/img/paper-review/uwtnet/fig2.webp' | relative_url }}" width="80%">
</center>
<br>

### Wavelet Convolutions
Wavelet Convolutions은 [WTconv]({% post_url paper-review/2026-01-19-wtconv %}) 처럼 효율적이고 간단한 Haar WT를 사용한다. 또한 해당 논문의 4가지 필터를 그대로 사용하는데 정의는 다음과 같다. 
$$
\begin{aligned}
F_{LL} &= \frac{1}{2}
\begin{bmatrix}
...
<center>
<img src="{{ '/assets/img/paper-review/uwtnet/tab1.webp' | relative_url }}" width="80%">
</center>
<br>

<center>
<img src="{{ '/assets/img/paper-review/uwtnet/fig3.webp' | relative_url }}" width="80%">
</center>
<br>
...
<center>
<img src="{{ '/assets/img/paper-review/uwtnet/tab2.webp' | relative_url }}" width="80%">
</center>
<br>
<center>
<img src="{{ '/assets/img/paper-review/uwtnet/tab3.webp' | relative_url }}" width="80%">
</center>
<br>
<center>
<img src="{{ '/assets/img/paper-review/uwtnet/tab4.webp' | relative_url }}" width="80%">
</center>
<br>
