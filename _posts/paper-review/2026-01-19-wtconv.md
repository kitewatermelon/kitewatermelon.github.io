...
<center>
<img src="{{ '/assets/img/paper-review/wtconv/fig2.webp' | relative_url }}" width="80%">
</center>
<br>
...
<center>
<img src="{{ '/assets/img/paper-review/wtconv/fig3.webp' | relative_url }}" width="80%">
</center>
<br>
...
<center>
<img src="{{ '/assets/img/paper-review/wtconv/tab2.webp' | relative_url }}" width="80%">
</center>
<br>
...
<center>
<img src="{{ '/assets/img/paper-review/wtconv/tab5.webp' | relative_url }}" width="80%">
</center>
<br>
...
<center>
<img src="{{ '/assets/img/paper-review/wtconv/tab6-7.webp' | relative_url }}" width="80%">
</center>
<br>
...
<center>
<img src="{{ '/assets/img/paper-review/wtconv/fig4.webp' | relative_url }}" width="80%">
</center>
<br>
...
<center>
<img src="{{ '/assets/img/paper-review/wtconv/fig1.webp' | relative_url }}" width="80%">
</center>
<br>
...
## 개인적인 생각
고전 신호 처리 기법을 이용하여 CNN의 한계를 돌파한 논문이다. 의료 분야는 데이터가 적고 취득 과정에서 많은 noise에 노출된다. 따라서 트렌드인 ViT를 사용하기가 개인적으로 꺼려졌는데 해당 layer를 도입하여 CNN을 쓰는 것이 좀 더 합리적인 방안이 될 수 있다는 생각이 든다. 참고로 2025 MICCAI에서 [WTConv를 이용한 논문]({% post_url paper-review/2026-01-21-uwtnet %})이 있다. WT-conv-IWT를 순차적으로 진행해야 하는 오버헤드가 있는 것은 다소 아쉽다.