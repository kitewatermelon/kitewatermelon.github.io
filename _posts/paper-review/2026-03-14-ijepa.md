...
tags:
  ...
  - CVPR
excerpt: "Self-Supervised Learning from Images with a Joint-Embedding Predictive Architecture (CVPR)"
use_math: true
classes: wide
---
>  CVPR 2023 [[Paper](https://arxiv.org/pdf/2301.08243)] [[GitHub](https://github.com/facebookresearch/ijepa)]  
...
### Prediction
context encoder의 출력 $s_x$가 주어졌을 때 우리는 $M$ 개의 target block의 
...
mask token은 positional embedding이 추가된 shared learnable vector이다.
